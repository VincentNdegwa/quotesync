        ...
        <div class="border-b px-4 py-3">
            ...
            <div class="grid grid-cols-1 gap-1.5 sm:grid-cols-2">
                <label
                    ...
                    ><Switch v-model="config.showContextText" class="scale-75"
                /></label>
                <label
                    class="flex cursor-pointer items-center justify-between rounded border px-2.5 py-1.5 text-sm hover:bg-muted/40"
                    ><span>Require typed name</span
                    ><Switch v-model="config.requireNameTyped" class="scale-75"
                /></label>
                <label
                    class="flex cursor-pointer items-center justify-between rounded border px-2.5 py-1.5 text-sm hover:bg-muted/40"
                    ><span>Allow draw signature</span
                    ><Switch
                        v-model="config.allowDrawSignature"
                        class="scale-75"
                /></label>
                <label
                    class="flex cursor-pointer items-center justify-between rounded border px-2.5 py-1.5 text-sm hover:bg-muted/40"
                    ><span>Show timestamp</span
                    ><Switch v-model="config.showTimestamp" class="scale-75"
                /></label>
                <label
                    class="flex cursor-pointer items-center justify-between rounded border px-2.5 py-1.5 text-sm hover:bg-muted/40"
                    ><span>Show IP address</span
                    ><Switch v-model="config.showIpAddress" class="scale-75"
                /></label>
                <label
                    class="flex cursor-pointer items-center justify-between rounded border px-2.5 py-1.5 text-sm hover:bg-muted/40"
                    ><span>Show accepted banner</span
                    ><Switch
                        v-model="config.showAcceptedBanner"
                        class="scale-75"
                /></label>
                <label
                    class="flex cursor-pointer items-center justify-between rounded border px-2.5 py-1.5 text-sm hover:bg-muted/40 sm:col-span-2"
                    ><span>Show declined banner</span
                    ><Switch
                        v-model="config.showDeclinedBanner"
                        class="scale-75"
                /></label>
            </div>
        </div>
        ...
        <div class="px-4 py-3">
            ...
            <div class="flex items-center gap-2">
                <div
                    ...
                    :style="{
                        backgroundColor: config.acceptButtonColor ?? '#2563eb',
                    }"
                >
                    <input
                ...
                <Button
                    ...
                    @click="config.acceptButtonColor = null"
                    >✕</Button
                >
            </div>
        </div>
