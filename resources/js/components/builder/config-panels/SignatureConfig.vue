        ...
        <div class="border-b px-4 py-3">
            ...
            <div class="mb-3 grid grid-cols-1 gap-2 md:grid-cols-2">
                <div class="space-y-1.5">
                    <p class="text-xs text-muted-foreground">Accept button text</p>
                    <Input v-model="config.acceptButtonText" class="h-8 text-sm" />
                </div>
                <div class="space-y-1.5">
                    <p class="text-xs text-muted-foreground">Decline button text</p>
                    <Input v-model="config.declineButtonText" class="h-8 text-sm" />
                </div>
            </div>

            <div class="mb-3 space-y-1.5">
                <p class="text-xs text-muted-foreground">Legal text</p>
                <Textarea v-model="config.legalText" rows="4" />
            </div>
