    ...
    <Dialog v-model:open="open">
        <DialogContent class="max-h-[90vh] max-w-3xl overflow-y-auto">
            <DialogHeader>
                ...
                <DialogDescription>
                    Describe your business and the AI will design a complete
                    template with layout, theme, and block configurations.
                </DialogDescription>
            </DialogHeader>
            ...
            <div v-else class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <p
                        v-if="generated.template_description"
                        class="text-sm text-muted-foreground"
                    >
                        {{ generated.template_description }}
                    </p>
                    <Badge
                        v-if="generated.industry"
                        variant="secondary"
                        class="capitalize"
                    >
                ...
                <!-- Theme Preview -->
                <div v-if="themePreview" class="rounded-lg border p-4">
                    <h4 class="mb-3 font-semibold">Theme Preview</h4>
                ...
                <!-- Block List -->
                <div
                    v-if="generated.layout?.blocks?.length"
                    class="rounded-lg border p-4"
                >
                    <h4 class="mb-3 font-semibold">
                        Blocks ({{ generated.layout.blocks.length }})
                    </h4>
                    <div class="space-y-1">
                        <div
                        ...
                        >
                            <span class="w-5 text-muted-foreground">{{
                                Number(index) + 1
                            }}</span>
                            <CheckCircle2
                                v-if="block.locked"
                            ...
                            />
                            <AlertCircle
                                v-else-if="!block.visible"
                                class="h-3.5 w-3.5 text-muted-foreground"
                            />
                            <Circle v-else class="h-3.5 w-3.5 text-green-500" />
