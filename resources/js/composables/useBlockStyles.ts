import type { BaseBlockConfig, BlockBorder, ContentBlockConfig, FontSize, Spacing } from '@/types'
...
export function spacingToCssPadding(spacing: Spacing | null | undefined): string {
...
export function blockBaseStyle(config: BaseBlockConfig): Record<string, string | undefined> {
  return {
...
export function blockContentStyle(config: ContentBlockConfig): Record<string, string | undefined> {
  return {
...
export function blockFontSizeClass(fontSize: FontSize | null | undefined): string {
