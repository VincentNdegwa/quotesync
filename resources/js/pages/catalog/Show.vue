    ...
    <div class="space-y-6">
        ...
        <div class="grid gap-4 md:grid-cols-3">
            ...
            <div class="rounded-md border p-4">
                ...
                <p class="text-2xl font-semibold">
                    {{ formatCurrency(margin.profit_per_unit) }}
                </p>
            </div>
            <div class="rounded-md border p-4">
        ...
        <div class="rounded-md border p-4">
            <div class="flex items-center justify-between">
                ...
                <Button size="sm" @click="openVariantDialog()"
                    >Add Variant</Button
                >
            </div>
        ...
        <div class="rounded-md border p-4">
            <div class="flex items-center justify-between">
                ...
                <Button size="sm" @click="openPriceTierDialog()"
                ...
                <TableBody>
                    ...
                    <TableRow v-else>
                        <TableCell
                            ...
                            class="text-center text-muted-foreground"
                        >
                            No price tiers added yet. Click "Add Price Tier" to
                            create one.
                        </TableCell>
                    </TableRow>
                </TableBody>
        ...
        <div class="rounded-md border p-4">
            ...
            <p class="mt-2 text-sm text-muted-foreground">
                Usage insights will appear here as quote line item tracking is
                added in the quote builder module.
            </p>
        </div>
